...
def login_api_for_start_attndance():
    ...
    payload = {"email": "tusharsuneri9039@gmail.com", "password": "9930@OEPP"}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            payload = {
                ...
                "token": data["token"],
                "content": "{\"Name Of The Project 01\\t\":\"Flovation Device\",\"Total No. Of Hours Worked On Project 01\\t\":\"Full\",\"Task Done In Project 01\\t\":\"--\",\"Name Of The Project 02\\t\":\"\",\"Total No. Of Hours Worked On Project 02\\t\":\"\",\"Task Done In Project 02\\t\":\"\",\"Name Of The Project 03\\t\":\"\",\"Total No. Of Hours Worked On Project 03\\t\":\"\",\"Task Done In Project 03\\t\":\"\",\"Date\":\"\"}",
