...
exports.productCruds = async (req, res) => {
  try {
    var { prod_id, prod_name, prod_type, unit, description, image, stock_thershold, price, batch, mfg, cgst, sgst, is_active } = req.body;

    if(prod_id)
    {
      let updateData = await productQuery.updateRoductDetails(prod_id, { prod_name, prod_type, unit,  description, image, price, stock_thershold, batch, mfg, cgst, sgst, is_active });
    ...
    let updateData = await productQuery.insertProductDetails({ prod_name, prod_type, unit, description, image, price, stock_thershold, batch, mfg, cgst, sgst });
